...
class HeifEditor(object):
    ...
    def findMetaBox(self):
        for box in self.rootBoxHeaders:
            if box.type == 'meta':
                return box

    def findIinfBox(self,MetaBox):
        for box in MetaBox.children:
            if box.type == 'iinf':
                return box

    def addInfeBox(self,InfeBox):
...
if __name__ == '__main__':
    heifeditor = HeifEditor()
    heifeditor.load("/home/kali/samples/IMG_3802b.HEIC")
    print(heifeditor.rootBoxHeaders)
    heifeditor.save("/home/kali/samples/IMG_3802_test.HEIC")

    MetaBox = heifeditor.findMetaBox()

    #bytes0 = MetaBox.serialize()

    IinfBox = heifeditor.findIinfBox(MetaBox)

    Infe47 = IinfBox.children[47]

    copyInfe47 = copy.deepcopy(Infe47)

    heifeditor.addInfeBox(copyInfe47)

    heifeditor.save("/home/kali/samples/IMG_3802_test2.HEIC")
